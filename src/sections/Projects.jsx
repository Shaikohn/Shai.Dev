...
export default function Projects() {
  const impostorImages = [impostorCover,imp1, imp2, imp3, imp4, imp5];
  /* const ztreamImages = [ztCover,zt1, zt2];
  const cuevanixImages = [cuCover, cu1, cu2]; */
  const casinoImages = [casCover,cas1, cas2, cas3, cas4];
  /* const fulboImages = [fulboCover, ful1, ful2, ful3]; */
  const pdbImages = [pdbCover, pdb1, pdb2, pdb3];
        ...
        <div className="space-y-24 md:space-y-28">
            ...
            <div className="order-1 md:order-2 max-w-xl text-center md:text-left transition-all duration-300 group-hover:-translate-y-1">
              ...
              <div className="flex justify-center md:justify-start flex-wrap gap-4">
                ...
                <button
                  ...
                  className="cursor-pointer text-sm font-medium text-zinc-400 px-5 py-2.5 rounded-full border border-white/10 hover:bg-white/10 hover:border-white/25 hover:scale-[1.03] transition-all duration-200"
                >
                  Screenshots
                </button>
              </div>
              ...
              <div className="mt-4 flex justify-center md:justify-start">
                <Link
                  to="/impostorfutbolero/privacy-policy"
                ...
                <div className="relative rounded-[32px] border border-white/10 bg-black/20 p-2 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-sm">
                  ...
                  >
                    <img
                      ...
                      className="h-[375px] md:h-[420px] object-contain rounded-[24px]"
                    />
                  </button>
                </div>
              </div>
          ...
          <article className="group grid md:grid-cols-[1.05fr_0.95fr] gap-8 md:gap-10 items-center opacity-90 hover:opacity-100 transition-all duration-300">
            ...
            <div className="order-1 max-w-xl text-center md:text-left transition-all duration-300 group-hover:-translate-y-1">
              ...
              <p className="text-zinc-400 leading-8 mb-4">
                Real-time multiplayer party game built around custom prompts, rotating judges, and chaotic social interactions.
              </p>

              <p className="text-zinc-400 leading-8 mb-4">
                Implemented synchronized game rounds, answer submission systems, judge resolution flows, rematches, and live room management across connected clients.
              </p>

              <p className="text-sm text-zinc-300 mb-3">
                Built around scalable real-time multiplayer systems.
              </p>
              ...
              <div className="flex justify-center md:justify-start flex-wrap gap-4">
                <a
                  href="https://play.google.com/store/apps/details?id=com.shaidev.pdb"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm font-semibold px-6 py-3 rounded-full bg-white text-[#0a0f1c] hover:scale-[1.05] hover:shadow-[0_10px_30px_rgba(255,255,255,0.15)] transition-all duration-200"
                >
                ...
                <button
                  onClick={() =>
                    openModal(pdbImages, "PDB (Pedazo de Boludo)", "mobile")
                  }
                  className="cursor-pointer text-sm font-medium text-zinc-400 px-5 py-2.5 rounded-full border border-white/10 hover:bg-white/10 hover:border-white/25 hover:scale-[1.03] transition-all duration-200"
                >
                  Screenshots
              ...
              <div className="relative transition-all duration-300 group-hover:scale-[1.02]">
                ...
                <div className="relative rounded-[32px] border border-white/10 bg-black/20 p-2 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-sm">
                  <button
                    ...
                    className="p-0 bg-transparent border-0 cursor-pointer"
                    aria-label="Open PDB screenshots"
                  >
                    <img
                      src={pdbCover}
                      alt="PDB (Pedazo de Boludo)"
                      className="h-[375px] md:h-[420px] object-contain rounded-[24px]"
                    />
                  </button>
                </div>
...
<div className="group">
  <div className="rounded-xl border border-white/10 bg-black/20 p-3 transition-all duration-300 group-hover:scale-[1.02] group-hover:border-white/20">
    ...
    <img
      src={ztreamCover}
      alt="ZtreamGames"
      className="rounded-lg mb-3 md:h-[150px] md:w-full md:object-cover"
    />
...
<div className="group">
  <div className="rounded-xl border border-white/10 bg-black/20 p-3 transition-all duration-300 group-hover:scale-[1.02] group-hover:border-white/20">
    ...
    <div className="flex items-center justify-between mb-2">
      ...
      <a
        href="https://github.com/Shaikohn/Fulbo"
        target="_blank"
        rel="noreferrer"
        className="text-xs border border-white/10 px-2.5 py-1 rounded-full text-zinc-300 hover:bg-white/10 hover:text-white transition-all"
      >
    ...
    <p className="text-xs text-zinc-500">
      Built the site from scratch, structuring the presale flow, responsive pages, and navigation.
    </p>
